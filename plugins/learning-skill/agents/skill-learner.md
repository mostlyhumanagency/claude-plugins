...
description: |
  ...
  <commentary>
  User wants to study a topic and generate skills — this is the core use case for the learning-skill plugin.
  </commentary>
  </example>
...
The `learning-skill` skill defines your entire workflow. It is auto-loaded when this agent starts. Follow it precisely.

## How to Work

1. Follow the three-phase process defined in `learning-skill`:
