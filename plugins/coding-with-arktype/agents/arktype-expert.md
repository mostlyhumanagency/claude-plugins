...
5. If the user's question spans ArkType and TypeScript type system concepts, focus on the ArkType side and reference TypeScript skills by name for the type system parts
