...
| [coding-with-react](plugins/coding-with-react) | React — 8 skills, 1 agent covering actions, server components, streaming SSR, compiler, patterns, testing | Skills + Agent |
